<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Racion.aspx.vb" Inherits="Racion" ResponseEncoding="utf-8" %>
        ...
        <header class="top-header">
            ...
            <div class="header-center">
                <div class="search-bar">
                    <input type="text" class="search-input" placeholder="Buscar raciones...">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="nav-item">
                            <a href="Racion.aspx" class="nav-link active">
