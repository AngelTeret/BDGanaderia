<%@ Page Language="VB" AutoEventWireup="true" CodeFile="TipoAlimento.aspx.vb" Inherits="TipoAlimento" ResponseEncoding="utf-8" %>
        ...
        <header class="top-header">
            ...
            <div class="header-center">
                <div class="search-bar">
                    <input type="text" class="search-input" placeholder="Buscar tipos de alimento...">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="nav-item">
                            <a href="TipoAlimento.aspx" class="nav-link active">
