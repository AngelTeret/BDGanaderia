<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Medicamento.aspx.vb" Inherits="Medicamento" ResponseEncoding="utf-8" %>
        ...
        <header class="top-header">
            ...
            <div class="header-center">
                <div class="search-bar">
                    <input type="text" class="search-input" placeholder="Buscar medicamentos...">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="nav-item">
                            <a href="Medicamento.aspx" class="nav-link active">
