<%@ Page Language="VB" AutoEventWireup="true" CodeFile="PeriodoProduccion.aspx.vb" Inherits="PeriodoProduccion" ResponseEncoding="utf-8" %>
        ...
        <header class="top-header">
            ...
            <div class="header-center">
                <div class="search-bar">
                    <input type="text" class="search-input" placeholder="Buscar períodos de producción...">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="nav-item">
                            <a href="PeriodoProduccion.aspx" class="nav-link active">
