<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Veterinario.aspx.vb" Inherits="Veterinario" ResponseEncoding="utf-8" %>
        ...
        <header class="top-header">
            ...
            <div class="header-center">
                <div class="search-bar">
                    <input type="text" class="search-input" placeholder="Buscar veterinarios...">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="nav-item">
                            <a href="Veterinario.aspx" class="nav-link active">
